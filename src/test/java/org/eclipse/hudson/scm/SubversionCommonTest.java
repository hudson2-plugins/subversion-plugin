...
import org.eclipse.hudson.scm.browsers.Sventon;
...
import static org.eclipse.hudson.scm.SubversionSCM.compareSVNAuthentications;
...
public class SubversionCommonTest extends AbstractSubversionTest {
    ...
    /**
     * Loads a test Subversion repository into a temporary directory, and creates {@link org.eclipse.hudson.scm.SubversionSCM} for it.
     */
